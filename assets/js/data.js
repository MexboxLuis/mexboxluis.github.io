const DB = {
  EN: {
    ...
    hero: {
      ...
      desc: "I build software that connects mobile apps, backends, and AI models — from Android clients to FastAPI services and ML pipelines.",
      ...
      items: [
        {
          ...
          desc: "Focused on machine learning, mobile and web development, and AI model integration.",
          icon: "graduation-cap"
        },
        {
          title: "Leader Formation Program",
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          tech: ["Kotlin", "Compose", "TensorFlow", "YOLOv8", "Flask"],
        ...
        {
          title: "CommuniSync",
          desc: "Community platform implemented in Jetpack Compose (and an XML variant, CommunityConnect) for local engagement.",
          tech: ["Android", "Compose", "XML", "Firebase"],
          img: "assets/img/projects/communisync.png",
          github: "https://github.com/MexboxLuis/CommuniSync",
          featured: false,
          date: "2024-06",
          details: {
            tech: "Built with Kotlin, Jetpack Compose (CommuniSync) and XML (CommunityConnect variant), Firebase Authentication, and Firestore for real-time synchronization.",
            purp: "A platform for users to report local issues, vote in polls, join forum discussions, and explore local services.",
            how: "Uses Firebase for secure authentication (Email, Google, Guest) and stores real-time data for reports, polls, and dynamic directory management."
          }
        },
        {
          title: "WaveRecorder",
          desc: "Android app for audio recording, playback speed filters, and local/cloud storage.",
          tech: ["Compose", "Kotlin", "Firebase"],
        ...
        {
          title: "EduStream API",
          desc: "Web CMS for uploading, categorizing, and streaming educational video content.",
          ...
          details: {
            ...
            purp: "A web CMS where teachers upload videos by subject and students can browse and stream them.",
    ...
    experience: {
      ...
      categories: [
        ...
        },
        {
          ...
          highlights: [
            "QR Attendance: Scan student credentials with validation and duplicate detection within a 45-minute window.",
        ...
        },
        {
          ...
          highlights: [
            ...
            "Model optimization: adapted SMPLer-X and Sewformer to run on local GPU-constrained environments, tuning inference pipelines for single-image input.",
  ...
  ES: {
    ...
    hero: {
      ...
      desc: "Construyo software que conecta apps móviles, backends y modelos de IA, desde clientes Android hasta servicios en FastAPI y pipelines de ML.",
      cvBtn: "Descargar CV",
      ...
      items: [
        {
          ...
          desc: "Enfocado en machine learning, desarrollo móvil y web, e integración de modelos de IA.",
          icon: "graduation-cap"
        },
        {
    ...
    projects: {
      ...
      items: [
        ...
        {
          title: "CommuniSync",
          desc: "Plataforma comunitaria implementada en Jetpack Compose (y una variante XML, CommunityConnect).",
          tech: ["Android", "Compose", "XML", "Firebase"],
          img: "assets/img/projects/communisync.png",
          github: "https://github.com/MexboxLuis/CommuniSync",
          featured: false,
          date: "2024-06",
          details: {
            tech: "Construida con Kotlin, Jetpack Compose y XML (CommunityConnect), Firebase Authentication, y Firestore para sincronización en tiempo real.",
            ...
            how: "Utiliza Firebase para autenticación segura (Correo, Google, Invitado) y almacena datos en tiempo real para reportes y encuestas."
          }
        },
        {
          title: "WaveRecorder",
        ...
        {
          title: "EduStream API",
          desc: "CMS web para subir, categorizar y transmitir contenido de video educativo.",
          tech: ["Node.js", "Express", "MySQL", "Handlebars"],
          img: "assets/img/projects/edustream.png",
          github: "https://github.com/MexboxLuis/EduStreamAPI",
          featured: false,
          ...
          details: {
            ...
            purp: "Un CMS web donde los profesores suben videos por materia y los alumnos pueden explorarlos y reproducirlos.",
      ...
      categories: [
        ...
        },
        {
          ...
          highlights: [
            ...
            "Optimización de modelos: adaptación de SMPLer-X y Sewformer para ejecutarse en entornos locales con GPU limitada, ajustando los pipelines de inferencia para entrada de imagen única.",
        ...
        },
        {
          ...
          highlights: [
            "Asistencia por QR: Escaneo de credenciales con validación y detección de duplicados en una ventana de 45 minutos.",
