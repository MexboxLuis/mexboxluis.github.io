...
\section*{Resumen}
Ingeniero en Inteligencia Artificial y desarrollador de software con experiencia en aplicaciones móviles, servicios backend e integración de modelos de IA. He trabajado en proyectos reales combinando Android, APIs, automatización, procesamiento de datos e interfaces orientadas a producto para conectar usuarios, datos y procesos de negocio.
...
\resumeSubheading
  ...
  \resumeItemListStart
    ...
    \resumeItem{Optimización de modelos: adaptación de SMPLer-X y Sewformer para ejecutarse en entornos locales con recursos limitados, ajustando los pipelines de inferencia para entrada de imagen única.}
    \resumeItem{Integración de SMPLer-X para extraer postura y forma corporal del usuario a partir de una sola fotografía.}
...
\resumeSubheading
  ...
  {Plataforma web de gestión de contenidos educativos}{}
  \resumeItemListStart
...
\resumeSubHeadingList
  \resumeItem{\textbf{Lenguajes:} Kotlin, Python, JavaScript, TypeScript, PHP, SQL, C\#}
  \resumeItem{\textbf{Móvil:} Android nativo, Jetpack Compose, Android Views/XML, Material 3, CameraX, Room, WorkManager, OkHttp, Coil, ZXing, React Native, Expo}
  ...
  \resumeItem{\textbf{Bases de datos / nube:} Firestore, Firebase Realtime Database, Firebase Storage, MySQL, SQLite}
